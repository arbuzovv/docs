...
* **US Stocks**: Comprehensive data on American equities.

* **ETFs**: Extensive coverage of Exchange-Traded Funds.

* **Futures**: Data on futures contracts for diversified strategy testing.
