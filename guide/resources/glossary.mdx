...
<AccordionGroup>
  ...
  <Accordion title="MarketData.TA">
    Finam's internal service that supplies market data to the platform.
  </Accordion>

  <Accordion title="Environment">
    An independent version of the platform for a specific market (Russian or US).
  </Accordion>

  <Accordion title="Global Auth">
    A shared authentication system — users stay signed in across Finam products.
  </Accordion>

  <Accordion title="Finam Trade API">
    Finam's programmatic interface for order execution; also a standalone Finam product for users who build their own trading systems.
  </Accordion>

  <Accordion title="Finam DMA">
    A separate Finam product offering direct market access for technical teams that need minimal latency.
  </Accordion>
