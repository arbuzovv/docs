...
The minimum backtesting interval is one minute, with aggregation available at 2, 3, 4 minutes or any larger interval. Historical data goes back to **2005**. Russian market data is available with no delay; US market data has a 15-minute delay.
