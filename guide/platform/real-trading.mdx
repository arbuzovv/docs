...
In the **Russian environment**, this happens through **Finam Trade API**: connecting is a matter of a click and a few trading parameters, with no manual integration work. In the **US environment**, live trading runs through the broker **Lime**, via the **LimeTrading SDK**.
