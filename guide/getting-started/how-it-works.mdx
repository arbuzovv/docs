...
<Steps>
  <Step title="Sign in">
    Authentication is shared across both environments through **Global Auth**. Once you're signed in to any Finam product, you stay signed in — no need to log in again.
  </Step>
