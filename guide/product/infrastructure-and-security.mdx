...
All market data comes from **MarketData.TA**, Finam's internal data service. Having a proprietary source keeps data quality and consistency under control across both environments.
...
For broker-side visibility, trades placed through Ziplime via Trade API carry a tag identifying them as originating from Ziplime. This makes it possible to measure the product's real contribution to trading activity.